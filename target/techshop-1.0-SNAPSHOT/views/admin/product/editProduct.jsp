                                                ...
                                                <c:if test="${product != null}">
													...
													* </span>
                                                        ...
                                                        <div class="form-group margin-bottom-10">
                                                            ...
                                                            <div class="col-md-10">
                                                                <input type="number" class="form-control" value="${product.price}" name="pojo.price" placeholder="">
                                                            </div>
                                                        </div>
                                                        <div class="form-group margin-bottom-10">
                                                            <label class="col-md-2 control-label">Số lượng: <span class="required">* </span></label>
                                                            <div class="col-md-10">
                                                                <input type="number" class="form-control" value="${product.quantity}" name="pojo.quantity" placeholder="">
                                                            </div>
                                                        </div>
                                                        <div class="form-group margin-bottom-10">
													...
													* </span>
                                                        ...
                                                        <div class="form-group margin-bottom-10">
                                                            <label class="col-md-2 control-label">Giá
                                                                <span class="required"> * </span></label>
                                                            <div class="col-md-10">
                                                                <input type="number" class="form-control" name="pojo.price" placeholder="">
                                                            </div>
                                                        </div>
                                                        <div class="form-group margin-bottom-10">
                                                            <label class="col-md-2 control-label">Số lượng: <span class="required">* </span></label>
                                                            <div class="col-md-10">
                                                                <input type="number" class="form-control" name="pojo.quantity" placeholder="">
                                                            </div>
                                                        </div>
                                                        <div class="form-group margin-bottom-10">
                                                            <label class="col-md-2 control-label">Hình ảnh: </label>
