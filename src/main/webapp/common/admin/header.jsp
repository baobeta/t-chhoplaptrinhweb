...
<div class="page-header">
  ...
  <div class="page-header-top">
    <div class="container">
      <!-- BEGIN LOGO -->
      <div class="page-logo">
        <a href="index.html"><img src="<c:url value='/static/assets/frontend/layout/img/logos/logo-shop-red.png'/>" alt="Metronic Shop UI"></a>
      </div>
      <!-- END LOGO -->
                ...
                <ul class="dropdown-menu-list scroller" style="height: 275px;" data-handle-color="#637283">
                  <li>
                    <a href="inbox.html?a=view">
										<span class="photo">
										<img src="<c:url value='/static/assets/admin/layout3/img/avatar2.jpg'/>" class="img-circle" alt="">
										</span>
                      <span class="subject">
										<span class="from">
										Lisa Wong </span>
                  ...
                  <li>
                    <a href="inbox.html?a=view">
										<span class="photo">
										<img src="<c:url value='/static/assets/admin/layout3/img/avatar3.jpg'/>" class="img-circle" alt="">
										</span>
                      <span class="subject">
										<span class="from">
										Richard Doe </span>
                  ...
                  <li>
                    <a href="inbox.html?a=view">
										<span class="photo">
										<img src="<c:url value='/static/assets/admin/layout3/img/avatar1.jpg'/>" class="img-circle" alt="">
										</span>
                      <span class="subject">
										<span class="from">
										Bob Nilson </span>
