                            ...
                            <li>
                                <ul class="dropdown-menu-list scroller" style="height: 275px;"
                                    ...
                                    <li>
										...
										<span class="photo">
										<img src="<c:url value='/static/assets/admin/layout3/img/avatar2.jpg'/>"
                                    ...
                                    <li>
                                        <a href="inbox.html?a=view">
										<span class="photo">
										<img src="<c:url value='/static/assets/admin/layout3/img/avatar3.jpg'/>"
                                             class="img-circle" alt="">
										</span>
                                            <span class="subject">
										<span class="from">
                                    ...
                                    <li>
                                        <a href="inbox.html?a=view">
										<span class="photo">
										<img src="<c:url value='/static/assets/admin/layout3/img/avatar1.jpg'/>"
                                             class="img-circle" alt="">
										</span>
                                            <span class="subject">
										<span class="from">
                        ...
                        <a href="javascript:;" class="dropdown-toggle" data-toggle="dropdown"
                           data-hover="dropdown" data-close-others="true">
                            <img alt="" class="img-circle"
                                 src="<c:url value='/static/assets/admin/layout3/img/avatar9.jpg'/>">
