                            ...
                            <div class="panel-body row">
                                ...
                                <div class="col-md-6 col-sm-6">
                                    <div class="form-group">
                                        ...
                                        <input type="text" id="address-dd" class="form-control"
                                               required>
                                    </div>
                                </div>
                                <div class="col-md-12">
                                        ...
                                        <table>
                                            <tr>
                                                ...
                                                <th class="checkout-quantity">
                                                    <fmt:message key="quantity" bundle="${lang}"/>
                                                </th>
                                            ...
                                            <c:forEach items="${cartItems}" var="item">
                                                ...
                                                <tr>
                                                    ...
                                                    <td class="checkout-description">
                                                        <h3><a href="#">${item.productDTO.name}</a>
                                                        </h3>
                                                        <p><strong>Item 1</strong> - Color: Green;
                                                            Size:
                                                            S</p>
