...
<script src="<c:url value='/static/assets/global/plugins/datatables/plugins/bootstrap/dataTables.bootstrap.js'/>"type="text/javascript" type="text/javascript"></script>
